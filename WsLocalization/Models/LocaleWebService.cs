...
#pragma warning restore CS8618 // Non-nullable field must contain a non-null value when exiting constructor. Consider declaring as nullable.
    ...
    public string UrlApiInfo => "api/info/";
    public string UrlGetBarcodeBottom => "api/get_barcode/bottom/";
    public string UrlGetBarcodeRight => "api/get_barcode/right/";
    public string UrlGetBarcodes => "api/get_barcodes/";
    public string UrlGetBarcodeTop => "api/get_barcode/top/";
    public string UrlSendBarcodeBottom => "api/send_barcode/bottom/";
    public string UrlSendBarcodeRight => "api/send_barcode/right/";
    public string UrlSendBarcodeTop => "api/send_barcode/top/";
    public string UrlSendBarcodeTopV2 => "api/send_barcode/top_v2/";
    public string UrlSendBrands => "api/send_brands/";
    public string UrlSendNomenclatures => "api/send_nomenclatures/";
    public string UrlSendNomenclaturesCharacteristics => "api/send_nomenclatures_characteristics/";
    public string UrlSendNomenclaturesGroups => "api/send_nomenclatures_groups/";
    public string UrlSendQuery => "api/send_query";
    public string UrlSendTest => "api/send_test/";
