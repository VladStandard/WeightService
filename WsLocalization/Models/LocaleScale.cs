...
#pragma warning restore CS8618 // Non-nullable field must contain a non-null value when exiting constructor. Consider declaring as nullable.
    ...
    public string CheckWeightIsZero => Lang == Lang.English ? "The platform is empty!" + Environment.NewLine + "Label printing is not possible!" : "Платформа пустая!" + Environment.NewLine + "Печать этикетки невозможна!";
