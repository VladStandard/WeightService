CREATE PROCEDURE [DW].[spFillFactAccountsReceivable2]

	@DocDate				datetime,
    @OrgID					varchar(36),
    @ContragentID			varchar(36),
...
BEGIN
	...
	SELECT 
        @DateID
		,[DW].[fnGetBinary1C](@OrgID)
		,[DW].[fnGetBinary1C](@ContragentID)
		,[DW].[fnGetBinary1C](@EmployeeID)
