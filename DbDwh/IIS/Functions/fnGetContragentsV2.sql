-- [IIS].[fnGetContragentsV2]

-- DROP FUNCTION
DROP FUNCTION IF EXISTS [IIS].[fnGetContragentsV2]
GO

-- CREATE FUNCTION
CREATE FUNCTION [IIS].[fnGetContragentsV2] (
...
-- ACCESS
GRANT EXECUTE ON [IIS].[fnGetContragentsV2] to [TerraSoftRole]
GO
...
--SELECT [IIS].[fnGetContragentsV2] (@code, DEFAULT, DEFAULT, DEFAULT, DEFAULT, DEFAULT) [fnGetContragentsV2]
SELECT [IIS].[fnGetContragentsV2] (DEFAULT, @id, DEFAULT, DEFAULT, DEFAULT, DEFAULT) [fnGetContragentsV2]
--SELECT [IIS].[fnGetContragentsV2] (DEFAULT, DEFAULT, @start_date, @end_date, DEFAULT, DEFAULT) [fnGetContragentsV2]
--SELECT [IIS].[fnGetContragentsV2] (DEFAULT, DEFAULT, @start_date, DEFAULT, DEFAULT, DEFAULT) [fnGetContragentsV2]
--SELECT [IIS].[fnGetContragentsV2] (DEFAULT, DEFAULT, DEFAULT, DEFAULT, DEFAULT, DEFAULT) [fnGetContragentsV2]
