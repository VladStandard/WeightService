-- [IIS].[fnGetNomenclaturesV2]

-- DROP FUNCTION
DROP FUNCTION IF EXISTS [IIS].[fnGetNomenclaturesV2]
GO

-- CREATE FUNCTION
CREATE FUNCTION [IIS].[fnGetNomenclaturesV2] (
...
-- ACCESS
GRANT EXECUTE ON [IIS].[fnGetNomenclaturesV2] TO [TerraSoftRole]
GO
...
--SELECT [IIS].[fnGetNomenclaturesV2] (@code, DEFAULT, DEFAULT, DEFAULT, DEFAULT, DEFAULT) [fnGetNomenclaturesV2]
--SELECT [IIS].[fnGetNomenclaturesV2] (DEFAULT, @id, DEFAULT, DEFAULT, DEFAULT, DEFAULT) [fnGetNomenclaturesV2]
--SELECT [IIS].[fnGetNomenclaturesV2] (DEFAULT, DEFAULT, @start_date, DEFAULT, DEFAULT, DEFAULT) [fnGetNomenclaturesV2]
--SELECT [IIS].[fnGetNomenclaturesV2] (DEFAULT, DEFAULT, @start_date, @end_date, DEFAULT, DEFAULT) [fnGetNomenclaturesV2]
--SELECT [IIS].[fnGetNomenclaturesV2] (DEFAULT, DEFAULT, DEFAULT, DEFAULT, DEFAULT, DEFAULT) [fnGetNomenclaturesV2]
