...
namespace DataCore
{
    public static class LocalizationData
    {
        ...
        public static class DeviceControl
        {
            ...
            public static string TableFieldGtin => Lang == ShareEnums.Lang.English ? @"___" : @"GTIN";
            public static string TableFieldGuidMercury => Lang == ShareEnums.Lang.English ? @"___" : @"GUID Mercury";
            ...
            public static string TableFieldItf14 => Lang == ShareEnums.Lang.English ? @"___" : @"ITF14";
            public static string TableFieldKneding => Lang == ShareEnums.Lang.English ? @"___" : @"Взвешено";
            public static string TableFieldLevel => Lang == ShareEnums.Lang.English ? @"___" : @"Уровень";
            public static string TableFieldLine => Lang == ShareEnums.Lang.English ? @"___" : @"Линия";
