...
public static class RazorFieldConfigUtils
{
	...
	public static class DeviceTypeFk
	{
		public static RazorFieldConfigModel GetDeviceLoginDt() => new(
			$"{nameof(DeviceModel)}.{nameof(DeviceModel.LoginDt)}", TextAlign.Center, LocaleCore.Table.LoginDt, nameof(DateTime));
		public static RazorFieldConfigModel GetDeviceLogoutDt() => new(
			$"{nameof(DeviceModel)}.{nameof(DeviceModel.LogoutDt)}", TextAlign.Center, LocaleCore.Table.LogoutDt);
		public static RazorFieldConfigModel GetDeviceName() => new(
			$"{nameof(DeviceModel)}.{nameof(DeviceModel.Name)}", TextAlign.Left, LocaleCore.Table.Name);
		public static RazorFieldConfigModel GetDevicePrettyName() => new(
			$"{nameof(DeviceModel)}.{nameof(DeviceModel.PrettyName)}", TextAlign.Left, LocaleCore.Table.PrettyName);
		public static RazorFieldConfigModel GetDeviceIpv4() => new(
			$"{nameof(DeviceModel)}.{nameof(DeviceModel.Ipv4)}", TextAlign.Left, LocaleCore.Table.DeviceIp);
		public static RazorFieldConfigModel GetDeviceMacAddress() => new(
			$"{nameof(DeviceModel)}.{nameof(DeviceModel.MacAddress)}", TextAlign.Center, LocaleCore.Table.DeviceMac);
		public static RazorFieldConfigModel GetDeviceTypeName() => new(
			$"{nameof(DeviceTypeModel)}.{nameof(DeviceTypeModel.Name)}", TextAlign.Left, LocaleCore.Table.Type);
	...
	public static class Base
	{
		...
		public static RazorFieldConfigModel GetDescription() => new(
	...
	public static class Printer
	{
		...
		public static RazorFieldConfigModel GetPrinterType(string link) => new(link, new PrinterTypeModel(), $"{nameof(PrinterTypeModel)}.{nameof(PrinterTypeModel.Name)}", TextAlign.Left, LocaleCore.Print.Type, "string");
	}

	public static class PrinterResource
	{
		public static RazorFieldConfigModel GetPrinter(string link) => new(link, new PrinterModel(),
			$"{nameof(PrinterModel)}.{nameof(PrinterModel.Name)}",
			TextAlign.Left, LocaleCore.Print.Name, "string");
		public static RazorFieldConfigModel GetResource(string link) => new(link, new PrinterResourceModel(),
			$"{nameof(TemplateResourceModel)}.{nameof(TemplateResourceModel.Name)}",
			TextAlign.Left, LocaleCore.Print.TemplateResource, "string");
	}
	...
	{
		public static RazorFieldConfigModel GetAddress() => new(
			$"{nameof(ProductionFacilityModel.Address)}", TextAlign.Left, LocaleCore.Table.Address);
		public static RazorFieldConfigModel GetName() => new(
	...
	{
		public static RazorFieldConfigModel GetName() => new(
			$"{nameof(WorkShopModel.Name)}", TextAlign.Left, LocaleCore.Table.Name);
		public static RazorFieldConfigModel GetProductionFacility(string link) => new(link, new ProductionFacilityModel(), 
			$"{nameof(ProductionFacilityModel)}.{nameof(ProductionFacilityModel.Name)}", 
			TextAlign.Left, LocaleCore.Table.ProductionFacility, "string");
	}
}
