...
public class BarCodeController : WebControllerBase //ApiController
{
    ...
    public ContentResult GetBarcodeTop([FromQuery] string barcode, bool useCrc = false,
        ...
        ControllerHelp.GetContentResult(() => {
            return new BarcodeTopModel(barcode, useCrc).GetContentResult<BarcodeTopModel>(formatString, HttpStatusCode.OK);
        }, formatString);
    ...
    public ContentResult GetBarcodeBottom([FromQuery] string barcode, [FromQuery(Name = "format")] string formatString = "") =>
        ControllerHelp.GetContentResult(() => {
            return new BarcodeBottomModel(barcode).GetContentResult<BarcodeBottomModel>(formatString, HttpStatusCode.OK);
        }, formatString);
    ...
    public ContentResult GetBarcodeRight([FromQuery] string barcode, [FromQuery(Name = "format")] string formatString = "") =>
        ControllerHelp.GetContentResult(() => {
            return new BarcodeRightModel(barcode).GetContentResult<BarcodeRightModel>(formatString, HttpStatusCode.OK);
        }, formatString);
    ...
    public ContentResult SendSqlquery([FromBody] string query, [FromQuery(Name = "format")] string formatString = "") =>
        ControllerHelp.GetContentResult(() => { 
            return ControllerHelp.NewResponse1CFromQuery(SessionFactory, query, null, formatString, false);
        }, formatString);
    ...
    public ContentResult SendBarcodeBottom([FromBody] BarcodeBottomModel barcodeBottom, 
        [FromQuery(Name = "format")] string formatString = "") =>
        ControllerHelp.GetContentResult(() => { 
            return ControllerHelp.NewResponse1CFromQuery(SessionFactory, 
                SqlQueriesBarcodes.FindBottom, new("VALUE_BOTTOM", barcodeBottom.GetValue()), formatString, false);
        }, formatString);
    ...
    public ContentResult SendBarcodeRight([FromBody] BarcodeRightModel barcodeRight, 
        [FromQuery(Name = "format")] string formatString = "") =>
        ControllerHelp.GetContentResult(() => { 
            return ControllerHelp.NewResponse1CFromQuery(SessionFactory, SqlQueriesBarcodes.FindRight, 
                new("VALUE_RIGHT", barcodeRight.GetValue()), formatString, false);
        }, formatString);
    ...
    public ContentResult SendBarcodeTop([FromBody] BarcodeTopModel barcodeTop, 
        ...
        ControllerHelp.GetContentResult(() => { 
            return ControllerHelp.NewResponse1CFromQuery(SessionFactory, SqlQueriesBarcodes.FindTop, 
                new("VALUE_TOP", barcodeTop.GetValue()), formatString, false);
        }, formatString);
