...
public class PluCharacteristicController : WebControllerBase
{
        ...
        [FromHeader(Name = "host")] string host = "", [FromHeader(Name = "accept")] string version = "")
    {
        ...
        ControllerHelp.LogRequest(nameof(WebApiScales), "api/send_nomenclatures_characteristics/", dtStamp, xml, format, host, version).ConfigureAwait(false);
        ...
        ControllerHelp.LogResponse(nameof(WebApiScales), "api/send_nomenclatures_characteristics/", dtStamp, result, format, host, version).ConfigureAwait(false);
        return result;
    }
