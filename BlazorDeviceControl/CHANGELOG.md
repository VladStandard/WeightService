...
- Items pages
## ќписание обновлени€:
- ¬осстановлено ограничение доступа к приложению дл€ неавторизованных пользователей.
- ѕрава доступа можно редактировать из приложени€.
- ƒобавлены пр€мые ссылки перехода из разделов в запись.
- –аздел и страница "”стройства": исправлены ошибки изменени€ и сохранени€ значений записи.
- –аздел и страница "ѕринтеры": добавлено поле статуса устройства (доступность по сети).
