...
namespace Ws.Database.Migrations
{
    ...
    [Migration("20241011084523_Add_Warehouse_To_PalletTable")]
    partial class Add_Warehouse_To_PalletTable
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Ws.Database.Entities.Print.LabelsZpl.LabelZplEntity", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier")
                        .HasColumnName("UID");
            ...
            modelBuilder.Entity("Ws.Database.Entities.Print.Pallets.PalletEntity", b =>
                {
                    ...
                    b.HasIndex("Number")
                        .IsUnique()
                        .HasDatabaseName("UQ_PALLETS__NUMBER");
            ...
            modelBuilder.Entity("Ws.Database.Entities.Ref.Printers.PrinterEntity", b =>
                {
                    ...
                    b.Property<Guid>("ProductionSiteId")
                        .HasColumnType("uniqueidentifier")
                    ...
                    b.HasIndex("Ip")
                        .IsUnique()
                        .HasDatabaseName("UQ_PRINTERS__IP");
            ...
            modelBuilder.Entity("Ws.Database.Entities.Print.Labels.LabelEntity", b =>
                {
                    ...
                    b.HasOne("Ws.Database.Entities.Print.Pallets.PalletEntity", "Pallet")
                        .WithMany()
            ...
            modelBuilder.Entity("Ws.Database.Entities.Print.LabelsZpl.LabelZplEntity", b =>
                {
                    b.HasOne("Ws.Database.Entities.Print.Labels.LabelEntity", null)
                        .WithOne("Zpl")
                        .HasForeignKey("Ws.Database.Entities.Print.LabelsZpl.LabelZplEntity", "Id")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("FK_LABELS_ZPL__LABEL");
                });
            ...
            modelBuilder.Entity("Ws.Database.Entities.Print.Pallets.PalletEntity", b =>
                {
                    ...
                    b.HasOne("Ws.Database.Entities.Ref.Warehouses.WarehouseEntity", "Warehouse")
                        ...
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired()
                        .HasConstraintName("FK_PALLETS__WAREHOUSE");
            ...
            modelBuilder.Entity("Ws.Database.Entities.Ref.Printers.PrinterEntity", b =>
                {
                    b.HasOne("Ws.Database.Entities.Ref.ProductionSites.ProductionSiteEntity", "ProductionSite")
                        ...
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired()
                        .HasConstraintName("FK_PRINTERS__PRODUCTION_SITE");
            ...
            modelBuilder.Entity("Ws.Database.Entities.Ref1C.Nestings.NestingEntity", b =>
                {
                    ...
                    b.HasOne("Ws.Database.Entities.Ref1C.Plus.PluEntity", null)
                        ...
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("FK_NESTINGS__PLU");
            ...
            modelBuilder.Entity("Ws.Database.Entities.Ref1C.Plus.PluEntity", b =>
                {
                    ...
                    b.HasOne("Ws.Database.Entities.Zpl.Templates.TemplateEntity", "Template")
                        .WithMany()
