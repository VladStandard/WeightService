...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Ws.Database.EntityFramework.Entities.Print.LabelsZpl.LabelZplEntity", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier")
                        .HasColumnName("UID");
            ...
            modelBuilder.Entity("Ws.Database.EntityFramework.Entities.Print.Pallets.PalletEntity", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier")
            ...
            modelBuilder.Entity("Ws.Database.EntityFramework.Views.Diag.DatabaseTables.DatabaseTableView", b =>
                {
            ...
            modelBuilder.Entity("Ws.Database.EntityFramework.Entities.Print.Labels.LabelEntity", b =>
                {
                    ...
                    b.HasOne("Ws.Database.EntityFramework.Entities.Print.Pallets.PalletEntity", "Pallet")
                        .WithMany()
            ...
            modelBuilder.Entity("Ws.Database.EntityFramework.Entities.Print.LabelsZpl.LabelZplEntity", b =>
                {
                    b.HasOne("Ws.Database.EntityFramework.Entities.Print.Labels.LabelEntity", null)
                        .WithOne("Zpl")
                        .HasForeignKey("Ws.Database.EntityFramework.Entities.Print.LabelsZpl.LabelZplEntity", "Id")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
            ...
            modelBuilder.Entity("Ws.Database.EntityFramework.Entities.Print.Pallets.PalletEntity", b =>
                {
                    b.HasOne("Ws.Database.EntityFramework.Entities.Ref.Lines.LineEntity", "Arm")
                        .WithMany()
                        .HasForeignKey("ARM_UID")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                    ...
                    b.HasOne("Ws.Database.EntityFramework.Entities.Ref.PalletMen.PalletManEntity", "PalletMan")
                        .WithMany()
