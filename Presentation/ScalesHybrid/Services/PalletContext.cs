using ScalesHybrid.Features.Pallet;
...
public class PalletContext: IDisposable
{
    ...
    private static IEnumerable<PalletModel> GetPallets() => 
        [
            new() { Uid = Guid.NewGuid(), Number = 9919998, Labels = 
            [
            ...
            new() { Uid = Guid.NewGuid(), Number = 9119998, Labels = [new() {IdentityValueUid = Guid.NewGuid()}, new() {IdentityValueUid = Guid.NewGuid()}] },
            new() { Uid = Guid.NewGuid(), Number = 9229999, Labels = [new() {IdentityValueUid = Guid.NewGuid()}] },
            new() { Uid = Guid.NewGuid(), Number = 9319998, Labels = [new() {IdentityValueUid = Guid.NewGuid()}, new() {IdentityValueUid = Guid.NewGuid()}] },
            new() { Uid = Guid.NewGuid(), Number = 9429999, Labels = [new() {IdentityValueUid = Guid.NewGuid()}] },
            new() { Uid = Guid.NewGuid(), Number = 9519698, Labels = [new() {IdentityValueUid = Guid.NewGuid()}, new() {IdentityValueUid = Guid.NewGuid()}] },
            new() { Uid = Guid.NewGuid(), Number = 9629999, Labels = [new() {IdentityValueUid = Guid.NewGuid()}] },
            new() { Uid = Guid.NewGuid(), Number = 9719998, Labels = [new() {IdentityValueUid = Guid.NewGuid()}, new() {IdentityValueUid = Guid.NewGuid()}] },
            new() { Uid = Guid.NewGuid(), Number = 9829999, Labels = [new() {IdentityValueUid = Guid.NewGuid()}] },
            new() { Uid = Guid.NewGuid(), Number = 9979998, Labels = [new() {IdentityValueUid = Guid.NewGuid()}, new() {IdentityValueUid = Guid.NewGuid()}] },
