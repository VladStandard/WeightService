...
public sealed partial class PalletFirstStageForm : ComponentBase
{
    ...
    private IEnumerable<PluNestingEntity> PluNestingsEntities { get; set; } = [];
    ...
    private void SetPluNestings()
    {
        ...
        PluNestingsEntities = PluService.GetAllPluNestings(FormModel.Plu);
        FormModel.Nesting = PluNestingsEntities.FirstOrDefault(item => item.IsDefault);
    }
}
