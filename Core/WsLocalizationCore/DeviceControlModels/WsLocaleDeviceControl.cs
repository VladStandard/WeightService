...
public sealed class WsLocaleDeviceControl : WsLocalizationDeviceControl
{
    ...
    public string ChartErrors => Lang == WsEnumLanguage.English ? "Errors" : "Ошибки";
    public string ChartMemory => Lang == WsEnumLanguage.English ? "Memory" : "Память ПО";
    public string ChartApp => Lang == WsEnumLanguage.English ? "App" : "ПО";
    public string ChartMemoryFree => Lang == WsEnumLanguage.English ? "Free" : "Свободно";
    public string ChartMemoryFreeColor => Lang == WsEnumLanguage.English ? "Free memory color" : "Цвет свободной памяти";
    public string ChartMemoryLeft => Lang == WsEnumLanguage.English ? "Size at MB" : "Размер в МБ";
    public string ChartSummary => Lang == WsEnumLanguage.English ? "Summary" : "Всего";
    public string ChartTimeInterval => Lang == WsEnumLanguage.English ? "Interval" : "Интервал";
    public string ChartTimeIntervalAll => Lang == WsEnumLanguage.English ? "All" : "Весь";
    public string ChartTimeIntervalAllAlert => Lang == WsEnumLanguage.English ? "The request can take a long time." : "Запрос может занять длительное время.";
    public string ChartTimeIntervalEmpty => Lang == WsEnumLanguage.English ? "Empty" : "Пусто";
    public string ChartTimeIntervalMonth => Lang == WsEnumLanguage.English ? "Month" : "Месяц";
    public string ChartTimeIntervalToday => Lang == WsEnumLanguage.English ? "Today" : "Сегодня";
    public string ChartTimeIntervalYear => Lang == WsEnumLanguage.English ? "Year" : "Год";
    public string ChartMemoryTotalColor => Lang == WsEnumLanguage.English ? "Total color" : "Цвет всего";
    public string ChartMemoryTotalFree => Lang == WsEnumLanguage.English ? "Free color" : "Цвет свободно";
    public string ChartMemoryType => Lang == WsEnumLanguage.English ? "Chart type" : "Тип графика";
    public string ChartMemoryValue => Lang == WsEnumLanguage.English ? "Value" : "Значение";
    
    public string ChartReport => Lang == WsEnumLanguage.English ? "Reports" : "Журналы";
    public string ChartReportFreeColor => Lang == WsEnumLanguage.English ? "Free memory color" : "Цвет свободной памяти";
    public string ChartReportLeft => Lang == WsEnumLanguage.English ? "Size at MB" : "Размер в МБ";
    public string ChartReportSummary => Lang == WsEnumLanguage.English ? "Summary" : "Всего";
    public string ChartReportTotalColor => Lang == WsEnumLanguage.English ? "Total color" : "Цвет всего";
    public string ChartReportTotalFree => Lang == WsEnumLanguage.English ? "Free color" : "Цвет свободно";
    public string ChartReportType => Lang == WsEnumLanguage.English ? "Chart type" : "Тип графика";
    public string ChartReportValue => Lang == WsEnumLanguage.English ? "Value" : "Значение";
    ...
    public string SectionCharts => Lang == WsEnumLanguage.English ? "Charts" : "Графики";
    ...
    public string SectionDashboard => Lang == WsEnumLanguage.English ? "Dashboard" : "Панель";
