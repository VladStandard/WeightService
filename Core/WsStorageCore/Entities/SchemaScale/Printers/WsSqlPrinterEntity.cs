...
public class WsSqlPrinterEntity : WsSqlTableBase
{
    ...
    public virtual WsSqlPrinterTypeEntity PrinterType { get; set; }
    ...
    public WsSqlPrinterEntity() : base(WsSqlEnumFieldIdentity.Id)
    {
        Ip = string.Empty;
        Port = 0;
