...
public class WsSqlPluNestingFkEntity : WsSqlTableBase
{
    ...
    public WsSqlPluNestingFkEntity() : base(WsSqlEnumFieldIdentity.Uid)
    {
        Box = new();
        //Plu = new();
        Plu = new();
    ...
    public WsSqlPluNestingFkEntity(WsSqlPluNestingFkEntity item) : base(item)
    {
        Box = new(item.Box);
        Plu = new(item.Plu);
    ...
    public override bool Equals(object obj)
    {
        ...
        return Equals((WsSqlPluNestingFkEntity)obj);
    }
    ...
    public virtual bool Equals(WsSqlPluNestingFkEntity item) =>
