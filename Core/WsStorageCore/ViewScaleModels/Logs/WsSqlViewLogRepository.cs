namespace WsStorageCore.ViewScaleModels.Logs;

public class WsSqlViewLogRepository
{
...
#pragma warning restore CS8618 // Non-nullable field must contain a non-null value when exiting constructor. Consider declaring as nullable.
    ...
    public List<WsSqlViewLogModel> GetList(WsSqlCrudConfigModel sqlCrudConfig, string? logType, string? line)
    {
