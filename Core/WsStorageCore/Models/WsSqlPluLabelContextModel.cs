...
public class WsSqlPluLabelContextModel : SerializeBase
{
    ...
    [XmlElement] public virtual string ProductDtWithCaption { get => $"{WsLocaleCore.Scales.LabelContextProductDt}: {ProductDt}"; set => _ = value; }
    ...
    [XmlElement] public virtual string Nesting { get => $"{WsLocaleCore.Scales.LabelContextNesting}: {ViewPluNesting.BundleCount}{WsLocaleCore.Table.NestingMeasurement}"; set => _ = value; }
    ...
    [XmlElement] public virtual string PluScaleNumber { get => $"{WsLocaleCore.Scales.LabelContextPlu}: {PluNumber} / {ScaleNumber}"; set => _ = value; }
    ...
    [XmlElement] public virtual string ExpirationDtWithCaption { get => $"{WsLocaleCore.Scales.LabelContextExpirationDt}: {ExpirationDt}"; set => _ = value; }
    [XmlElement] public virtual string ScaleNumber { get => $"{PluScale.Line.Number:00000}"; set => _ = value; }
    [XmlElement] public virtual string ScaleDescription { get => $"{WsLocaleCore.Scales.LabelContextWorkShop}: {PluScale.Line.Description}"; set => _ = value; }
    ...
    [XmlElement] public virtual string PluWeighing2Dot3RusKg { get => $"{WsLocaleCore.Scales.LabelContextWeight}: {PluWeighing.NettoWeight:#0.000} {WsLocaleCore.Scales.WeightUnitKg}".Replace('.', ','); set => _ = value; }
    ...
    [XmlElement] public virtual string PluWeighingKneadingWithCaption { get => $"{WsLocaleCore.Scales.LabelContextKneading}: {PluWeighingKneading}"; set => _ = value; }
