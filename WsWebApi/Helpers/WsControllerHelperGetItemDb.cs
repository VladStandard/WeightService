...
public sealed partial class WsControllerHelper
{
    ...
    /// <returns></returns>
    private bool GetPluDb(WsResponse1cShortModel response, Guid uid1c, Guid uid1cException,
    ...
    /// <param name="itemDb"></param>
    /// <returns></returns>
    private bool GetBundleDb(WsResponse1cShortModel response, Guid uid1c, Guid uid1cException,
    ...
    /// <param name="itemDb"></param>
    /// <returns></returns>
    private bool GetBrandDb(WsResponse1cShortModel response, Guid uid1c, Guid uid1cException,
    ...
    /// <param name="itemDb"></param>
    /// <returns></returns>
    private bool GetClipDb(WsResponse1cShortModel response, Guid uid1c, Guid uid1cException,
    ...
    /// <param name="itemDb"></param>
    /// <returns></returns>
    private bool GetBoxDb(WsResponse1cShortModel response, Guid uid1c, Guid uid1cException,
    ...
    /// <param name="itemDb"></param>
    /// <returns></returns>
    private bool GetPluCharacteristicDb(WsResponse1cShortModel response, Guid uid1c, Guid uid1cException,
