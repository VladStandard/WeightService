...
/// Test controller v2.
/// </summary>
internal sealed class WsTestControllerV2 : WsWebControllerBase
{
    ...
    public ContentResult GetException([FromQuery(Name = "format")] string format = "", [FromQuery(Name = "debug")] bool isDebug = false) =>
        GetContentResult(() =>
        {
            string response = WsWebSqlUtils.GetResponse<string>(SessionFactory, SqlQueriesV2.GetException);
    ...
    public ContentResult GetSimple([FromQuery(Name = "format")] string format = "", [FromQuery(Name = "debug")] bool isDebug = false,
        ...
        GetContentResult(() =>
        {
            ...
            {
                case 1:
                    string response1 = WsWebSqlUtils.GetResponse<string>(SessionFactory, SqlQueriesV2.GetXmlSimpleV1);
                ...
                case 2:
                    string response2 = WsWebSqlUtils.GetResponse<string>(SessionFactory, SqlQueriesV2.GetXmlSimpleV2);
                ...
                case 3:
                    string response3 = WsWebSqlUtils.GetResponse<string>(SessionFactory, SqlQueriesV2.GetXmlSimpleV3);
                ...
                case 4:
                    string response4 = WsWebSqlUtils.GetResponse<string>(SessionFactory, SqlQueriesV2.GetXmlSimpleV4);
