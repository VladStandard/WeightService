...
## [0.6.790] - 2022-06-02
### Описание обновления:
- WS-T-219. Счётчик для каждого устройства
- WS-T-223. Значение по умолчанию для поля номер

## [0.6.770] - 2022-05-31
### Описание обновления:
- WS-T-211. Срочное исправление 'Переменная или параметр "deviceid" не определена'
