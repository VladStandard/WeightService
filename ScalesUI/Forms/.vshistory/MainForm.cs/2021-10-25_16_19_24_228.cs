...
namespace ScalesUI.Forms
{
    public partial class MainForm : Form
    {
        ...
        private PrintManagerHelper _printManager = PrintManagerHelper.Instance;
        ...
        private void MainForm_Load(object sender, EventArgs e)
        {
            ...
            {
                _taskManager.Close();
                _taskManager.ClosePrintManager();
            ...
            finally
            {
                ...
                _taskManager.Open(CallbackDeviceManager, CallbackMemoryManager, CallbackMassaManager,
        ...
        private void CallbackPrintManager()
        {
            ...
            if (_sessionState.CurrentScale?.ZebraPrinter != null && _sessionState.IsTscPrinter)
            {
                ...
                {
                    MDSoft.WinFormsUtils.InvokeControl.SetText(fieldPrintManager, _taskManager.PrintManager.TscPrintControl.IsOpen
            ...
            else
            {
                ...
                if (_taskManager.PrintManager.CurrentStatus != null)
                {
                    MDSoft.WinFormsUtils.InvokeControl.SetText(fieldPrintManager, _taskManager.PrintManager.CurrentStatus.isReadyToPrint
                        ? $"Принтер: доступен | {_taskManager.PrintManager.TscPrintControl.IpAddress} | {ch}" : $"Принтер: недоступен | {ch}");
                }
            }
        ...
        private void ButtonPrint_Click(object sender, EventArgs e)
        {
            try
            {
                _taskManager.OpenPrintManager(CallbackPrintManager, _sessionState.SqlViewModel, _sessionState.IsTscPrinter, _sessionState.CurrentScale);
                _sessionState.PrintLabel(Owner);
                while (!_printManager.PrintCmdQueue.IsEmpty)
                {
