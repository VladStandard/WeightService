...
namespace ScalesUI.Forms
{
    public partial class MainForm : Form
    {
        ...
        private void CallbackPrintManager()
        {
            ...
            _sessionState.LabelsCurrent = TaskManager.PrintManager.UserLabelCount < _sessionState.LabelsCount ? _sessionState.TaskManager.PrintManager.UserLabelCount : _sessionState.LabelsCount;
        ...
        private void ButtonPrint_Click(object sender, EventArgs e)
        {
            try
            {
                _sessionState.TaskManager.OpenPrintManager(CallbackPrintManager, _sessionState.SqlViewModel, _sessionState.IsTscPrinter, _sessionState.CurrentScale);
