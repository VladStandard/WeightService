...
public partial class SelectPluForm : Form
{
	...
	private ControlPluEntity NewControlGroup(PluScaleEntity pluScale, int pageNumber, ushort buttonNumber)
	{
	    ...
	    Button buttonPlu = NewButtonPlu(pluScale, tabIndex);
	    Label labelPluNumber = NewLabelPluNumber(pluScale, tabIndex, buttonPlu);
	    Label labelPluType = NewLabelPluType(pluScale, tabIndex, buttonPlu);
	    Label labelPluCode = NewLabelPluCode(pluScale, tabIndex, buttonPlu);
	...
	private Button NewButtonPlu(PluScaleEntity pluScale, int tabIndex)
	{
	...
	{
	    TemplateDirect template1 = new PluDirect().LoadTemplate();
