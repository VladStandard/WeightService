...
public class WsSqlPluEntity : WsSqlTable1CBase
{
    ...
    public virtual WsSqlBundleEntity Bundle { get; set; }
    public virtual WsSqlBrandEntity Brand { get; set; }
    public override string DisplayName => $"{Number} | {Name}";
    
    public WsSqlPluEntity() : base(WsSqlEnumFieldIdentity.Uid)
    {
    ...
    public WsSqlPluEntity(WsSqlPluEntity item) : base(item)
    {
    ...
    public override bool Equals(object obj)
    {
        ...
        return Equals((WsSqlPluEntity)obj);
    }
    ...
    public virtual bool Equals(WsSqlPluEntity item) =>
