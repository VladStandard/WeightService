...
public sealed class SqlClaimRepository : BaseRepository, IGetItemByUid<ClaimEntity>, IGetAll<ClaimEntity>, IUpdate<ClaimEntity>, ISave<ClaimEntity>
{
    ...
    public ClaimEntity Update(ClaimEntity item) => (Session.Save(item) as ClaimEntity)!;
