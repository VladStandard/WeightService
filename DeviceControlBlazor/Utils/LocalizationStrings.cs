...
namespace DeviceControlBlazor.Utils
{
    public static class LocalizationStrings
    {
        ...
        #region Главная
        public const string SqlServerRelease = "PALYCH";
        public const string SqlServerDebug = "CREATIO";
        ...
        public static string IdentityError { get => Lang == EnumLang.Eng ? @"User error!" : @"Ошибка пользователя"; }
        public static string NotLoad { get => Lang == EnumLang.Eng ? @"Not load!" : @"Не загружено"; }
        #endregion
        #region Methods
        public static string MethodOnInitializedAsync { get => Lang == EnumLang.Eng ? @"Method OnInitializedAsync" : @"Метод OnInitializedAsync"; }
        #endregion
