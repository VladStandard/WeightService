...
namespace DeviceControlBlazor.Components.Record
{
    public partial class Printer
    {
        ...
        private void Save()
        {
            ...
            Navigation.NavigateTo($"{LocalizationStrings.UriRouteTablePrinters}");
        }

        private async Task SaveAsync()
        {
            Task task = new(Save);
            await RunTasksWithQeustion(LocalizationStrings.TableRecordSave,
        ...
        {
            await RunTasks(LocalizationStrings.TableRecordCancel,
                LocalizationStrings.DialogResultSuccess, LocalizationStrings.DialogResultFail, LocalizationStrings.DialogResultCancel,
                new List<Task> {
                    new(() => {
                        if (Item == null || Item.EqualsDefault())
