...
namespace WeightCore.MassaK
{
    ...
    public class AskError : ResponseEntity
    {
    ...
    public class AskSetTare : ResponseEntity
    {
    ...
    public class AskNackTare : ResponseEntity
    {
    ...
    public class AskSetZero : ResponseEntity
    {
    ...
    public class AskGetMassa : ResponseEntity
    {
        public int Weight;
    ...
    public class AskScalePar : ResponseEntity
    {
