...
namespace WeightCore.Managers
{
    public class MassaManagerHelper
    {
        ...
        public void Init(DeviceSocket deviceSocket, int waitWhileMiliSeconds, int waitExceptionMiliSeconds, int waitCloseMiliSeconds)
        {
    ...
    public class DeviceSocketTcp : DeviceSocket
    {
        ...
        public override byte[] Bytes(byte[] request)
        {
            ...
            {
                _log.Error(nameof(DeviceSocket), nameof(Bytes), ex.Message);
            }
