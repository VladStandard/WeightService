...
namespace WeightCore.Managers
{
    public class TaskManagerEntity
    {
        ...
        private PrintManagerEntity PrintManager = PrintManagerEntity.Instance;
        ...
        public void OpenPrintManager(PrintManagerEntity.Callback callbackPrintManager, SqlViewModelEntity sqlViewModel, bool isTscPrinter, 
        ...
        public void ClosePrintManager()
        {
            try
            {
                ...
                _ctsPrintManager.Cancel();
                PrintManager?.Close();
                //if (PrintManager != null && IsTscPrinter && !PrintManager.PrintControl.IsStatusNormal)
                ...
                using (await _mutexPrintManager.LockAsync())
                {
                    ...
                    try
                    {
                        ...
                        if (sqlViewModel.IsTaskEnabled(ProjectsEnums.TaskType.PrintManager))
                        {
                            ...
                            {
                                PrintManager = new PrintManagerEntity(currentScale.ZebraPrinter.Name, currentScale.ZebraPrinter.Ip, 
                                    currentScale.ZebraPrinter.Port, 1_000, 5_000, 5_000);
                            }
