...
namespace WeightCore.Managers
{
    public class TaskManagerHelper
    {
        ...
        public DeviceManagerHelper DeviceManager { get; set; }
        ...
        public MemoryManagerHelper MemoryManager { get; set; }
        ...
        public MassaManagerHelper MassaManager { get; set; }
                ...
                using (await _mutexDeviceManager.LockAsync())
                {
                    ...
                    try
                    {
                        ...
                        if (sqlViewModel.IsTaskEnabled(ProjectsEnums.TaskType.DeviceManager))
                        {
                            ...
                            {
                                DeviceManager = new DeviceManagerHelper(1_000, 5_000, 5_000);
                            }
                            if (IsDebug)
                ...
                using (await _mutexMemoryManager.LockAsync())
                {
                    ...
                    try
                    {
                        ...
                        if (sqlViewModel.IsTaskEnabled(ProjectsEnums.TaskType.MemoryManager))
                        {
                            ...
                            {
                                MemoryManager = new MemoryManagerHelper(1_000, 5_000, 5_000);
                            }
                            if (IsDebug)
