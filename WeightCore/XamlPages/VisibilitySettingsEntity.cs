...
namespace WeightCore.XamlPages
{
    public class VisibilitySettingsEntity : BaseViewModel
    {
        ...
        {
            ButtonAbortContent = LocalizationData.Buttons.Abort;
            ButtonCancelContent = LocalizationData.Buttons.Cancel;
            ButtonCustomContent = LocalizationData.Buttons.Custom;
            ButtonIgnoreContent = LocalizationData.Buttons.Ignore;
            ButtonNoContent = LocalizationData.Buttons.No;
            ButtonOkContent = LocalizationData.Buttons.Ok;
            ButtonRetryContent = LocalizationData.Buttons.Retry;
            ButtonYesContent = LocalizationData.Buttons.Yes;
        }
