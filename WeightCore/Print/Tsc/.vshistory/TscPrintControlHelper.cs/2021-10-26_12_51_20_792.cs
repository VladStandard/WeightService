    ...
    public class TscPrintControlHelper : BaseViewModel
    {
        ...
        public PrintStatus GetStatusAsEnum(byte? value)
        {
            return value switch
            {
                ...
                (byte)0x00 => 0x00,
                // Head opened
                (byte)0x01 => (PrintStatus)0x01,
                // Paper Jam
                (byte)0x02 => (PrintStatus)0x02,
                // Paper Jam and head opened
                (byte)0x03 => (PrintStatus)0x03,
                // Out of paper
                (byte)0x04 => (PrintStatus)0x04,
                // Out of paper and head opened
                (byte)0x05 => (PrintStatus)0x05,
                // Out of ribbon
                (byte)0x08 => (PrintStatus)0x08,
                // Out of ribbon and head opened
                (byte)0x09 => (PrintStatus)0x09,
                // Out of ribbon and paper jam
                (byte)0x0A => (PrintStatus)0x0A,
                // Out of ribbon, paper jam and head opened
                (byte)0x0B => (PrintStatus)0x0B,
                // Out of ribbon and out of paper
                (byte)0x0C => (PrintStatus)0x0C,
                // Out of ribbon, out of paper and head opened
                (byte)0x0D => (PrintStatus)0x0D,
                // Pause
                (byte)0x10 => (PrintStatus)0x10,
                // Printing
                (byte)0x20 => (PrintStatus)0x20,
        ...
        public string GetStatusAsStringEng(byte? value)
        {
            return value switch
            {
                ...
                (byte)0x00 => "Normal",
                // Head opened
                (byte)0x01 => "Head opened",
                // Paper Jam
                (byte)0x02 => "Paper Jam",
                // Paper Jam and head opened
                (byte)0x03 => "Paper Jam and head opened",
                // Out of paper
                (byte)0x04 => "Out of paper",
                // Out of paper and head opened
                (byte)0x05 => "Out of paper and head opened",
                // Out of ribbon
                (byte)0x08 => "Out of ribbon",
                // Out of ribbon and head opened
                (byte)0x09 => "Out of ribbon and head opened",
                // Out of ribbon and paper jam
                (byte)0x0A => "Out of ribbon and paper jam",
                // Out of ribbon, paper jam and head opened
                (byte)0x0B => "Out of ribbon, paper jam and head opened",
                // Out of ribbon and out of paper
                (byte)0x0C => "Out of ribbon and out of paper",
                // Out of ribbon, out of paper and head opened
                (byte)0x0D => "Out of ribbon, out of paper and head opened",
                // Pause
                (byte)0x10 => "Pause",
                // Printing
                (byte)0x20 => "Printing",
