...
/// </summary>
#nullable enable
public class PluginPrintModel : PluginBaseHelper
{
    ...
    protected static LabelSessionHelper LabelSession => LabelSessionHelper.Instance;
    ...
    protected PluginPrintModel()
    {
        PluginType = EnumPluginType.Print;
    ...
    protected string GetPrinterStatusDescription(EnumLanguage lang, MdWinPrinterStatus printerStatus) =>
        lang switch
        {
            EnumLanguage.Russian => printerStatus switch
            {
