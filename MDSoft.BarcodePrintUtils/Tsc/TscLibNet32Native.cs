...
public class TscLibNet32Native
{

	[DllImport("tsclibnet_x86.dll", EntryPoint = "about")]
	public static extern int About();

	[DllImport("tsclibnet_x86.dll", EntryPoint = "barcode")]
	...
	[DllImport("tsclibnet_x86.dll", EntryPoint = "clearbuffer")]
	public static extern int ClearBuffer();

	[DllImport("tsclibnet_x86.dll", EntryPoint = "closeport")]
	public static extern int ClosePort();

	[DllImport("tsclibnet_x86.dll", EntryPoint = "downloadpcx")]
	public static extern int DownloadPcx(string fileName, string imageName);

	[DllImport("tsclibnet_x86.dll", EntryPoint = "formfeed")]
	public static extern int FormFeed();

	[DllImport("tsclibnet_x86.dll", EntryPoint = "nobackfeed")]
	public static extern int NobackFeed();

	[DllImport("tsclibnet_x86.dll", EntryPoint = "openport")]
	public static extern int OpenPort(string printername);

	[DllImport("tsclibnet_x86.dll", EntryPoint = "printerfont")]
	...
	[DllImport("tsclibnet_x86.dll", EntryPoint = "printlabel")]
	public static extern int PrintLabel(string set, string copy);

	[DllImport("tsclibnet_x86.dll", EntryPoint = "sendBinaryData")]
	public static extern int SendBinaryData(byte[] content, int length);

	[DllImport("tsclibnet_x86.dll", EntryPoint = "sendcommand")]
	public static extern int SendCommand(string printercommand);

	[DllImport("tsclibnet_x86.dll", EntryPoint = "setup")]
	...
	[DllImport("tsclibnet_x86.dll", EntryPoint = "socketsend")]
	public static extern string SocketSend(string ip, int port);
        
	[DllImport("tsclibnet_x86.dll", EntryPoint = "test")]
	public static extern string Test();

	[DllImport("tsclibnet_x86.dll", EntryPoint = "tscudp_run")]
	public static extern string UdpRun();

	[DllImport("tsclibnet_x86.dll", EntryPoint = "usbportqueryprinter")]
	public static extern byte UsbPortQueryPrinter();

	[DllImport("tsclibnet_x86.dll", EntryPoint = "windowsfont")]
	...
	[DllImport("tsclibnet_x86.dll", EntryPoint = "windowsfontUnicode")]
