...
namespace DataShareCore.Schedulers
{
    public static class QuartzUtils
    {
        public static ITrigger? CreateTrigger(string name, string group, TimeSpan timeSpan, bool repeatForever) =>
            new QuartzTriggerEntity(name, group, timeSpan, repeatForever).Trigger;

        public static ITrigger? CreateTrigger(string name, string group, string cronExpression, bool repeatForever) =>
            new QuartzTriggerEntity(name, group, cronExpression, repeatForever).Trigger;

        public static ITrigger? CreateTrigger(string name, string group, QuartzEnums.Interval interval, int length, bool repeatForever) =>
            new QuartzTriggerEntity(name, group, interval, length, repeatForever).Trigger;
