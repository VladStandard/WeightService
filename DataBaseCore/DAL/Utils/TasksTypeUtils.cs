    ...
    public static class TasksTypeUtils
    {
        ...
        public static Guid GetTaskTypeUid(string taskTypeName)
        {
            ...
            using (SqlConnection con = SqlConnectFactory.GetConnection())
            {
                ...
                using (SqlCommand cmd = new SqlCommand(SqlQueries.TaskTypes.GetTaskTypeUid))
                {
                    cmd.Connection = con;
        ...
        public static TaskTypeEntity GetTaskType(string name)
        {
            ...
            {
                con.Open();
                using (SqlCommand cmd = new SqlCommand(SqlQueries.TaskTypes.GetTasksTypesByName))
                {
                    cmd.Connection = con;
                    cmd.Parameters.Clear();
        ...
        public static TaskTypeEntity GetTaskType(Guid uid)
        {
            ...
            {
                con.Open();
                using (SqlCommand cmd = new SqlCommand(SqlQueries.TaskTypes.GetTasksTypesByUid))
                {
                    cmd.Connection = con;
                    cmd.Parameters.Clear();
        ...
        public static List<TaskTypeEntity> GetTasksTypes()
        {
            ...
            {
                con.Open();
                using (SqlCommand cmd = new SqlCommand(SqlQueries.TaskTypes.GetTasksTypes))
                {
                    cmd.Connection = con;
                    cmd.Parameters.Clear();
                    using (SqlDataReader reader = cmd.ExecuteReader())
