...
public class ErrorUtilTests
{
    ...
    {
        Assert.True(ErrorUtil.Suppress(() => throw new ArgumentNullException(), typeof(ArgumentNullException), typeof(NotImplementedException)));
        Assert.True(ErrorUtil.Suppress(() => throw new NotImplementedException(), typeof(ArgumentNullException), typeof(NotImplementedException)));
    }
}