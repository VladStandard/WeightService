...
using WsDataCore.Files;
using WsDataCore.Protocols;
using WsDataCore.Sql.Core.Enums;
using WsDataCore.Sql.Core.Helpers;
using WsDataCore.Sql.Core.Models;
using WsDataCore.Sql.Core.Utils;
using WsDataCore.Sql.Models;
using WsDataCore.Sql.TableDiagModels.Logs;
using WsDataCore.Sql.TableDiagModels.LogsTypes;
using WsDataCore.Sql.TableDiagModels.LogsWebs;
using WsDataCore.Sql.TableDiagModels.LogsWebsFks;
using WsDataCore.Sql.TableDiagModels.ScalesScreenshots;
using WsDataCore.Sql.Tables;
using WsDataCore.Sql.TableScaleFkModels.DeviceScalesFks;
using WsDataCore.Sql.TableScaleFkModels.DeviceTypesFks;
using WsDataCore.Sql.TableScaleFkModels.PlusBundlesFks;
using WsDataCore.Sql.TableScaleFkModels.PlusCharacteristicsFks;
using WsDataCore.Sql.TableScaleFkModels.PlusClipsFks;
using WsDataCore.Sql.TableScaleFkModels.PlusFks;
using WsDataCore.Sql.TableScaleFkModels.PlusGroupsFks;
using WsDataCore.Sql.TableScaleFkModels.PlusLabels;
using WsDataCore.Sql.TableScaleFkModels.PlusNestingFks;
using WsDataCore.Sql.TableScaleFkModels.PlusStorageMethodsFks;
using WsDataCore.Sql.TableScaleFkModels.PlusTemplatesFks;
using WsDataCore.Sql.TableScaleFkModels.PlusWeighingsFks;
using WsDataCore.Sql.TableScaleFkModels.PrintersResourcesFks;
using WsDataCore.Sql.TableScaleModels.Access;
using WsDataCore.Sql.TableScaleModels.Apps;
using WsDataCore.Sql.TableScaleModels.BarCodes;
using WsDataCore.Sql.TableScaleModels.Boxes;
using WsDataCore.Sql.TableScaleModels.Brands;
using WsDataCore.Sql.TableScaleModels.Bundles;
using WsDataCore.Sql.TableScaleModels.Clips;
using WsDataCore.Sql.TableScaleModels.Contragents;
using WsDataCore.Sql.TableScaleModels.Devices;
using WsDataCore.Sql.TableScaleModels.DeviceTypes;
using WsDataCore.Sql.TableScaleModels.Orders;
using WsDataCore.Sql.TableScaleModels.OrdersWeighings;
using WsDataCore.Sql.TableScaleModels.Organizations;
using WsDataCore.Sql.TableScaleModels.Plus;
using WsDataCore.Sql.TableScaleModels.PlusCharacteristics;
using WsDataCore.Sql.TableScaleModels.PlusGroups;
using WsDataCore.Sql.TableScaleModels.PlusScales;
using WsDataCore.Sql.TableScaleModels.PlusStorageMethods;
using WsDataCore.Sql.TableScaleModels.Printers;
using WsDataCore.Sql.TableScaleModels.PrintersTypes;
using WsDataCore.Sql.TableScaleModels.ProductionFacilities;
using WsDataCore.Sql.TableScaleModels.ProductSeries;
using WsDataCore.Sql.TableScaleModels.Scales;
using WsDataCore.Sql.TableScaleModels.Tasks;
using WsDataCore.Sql.TableScaleModels.TasksTypes;
using WsDataCore.Sql.TableScaleModels.Templates;
using WsDataCore.Sql.TableScaleModels.TemplatesResources;
using WsDataCore.Sql.TableScaleModels.Versions;
using WsDataCore.Sql.TableScaleModels.WorkShops;
...
#pragma warning restore CS8618 // Non-nullable field must contain a non-null value when exiting constructor. Consider declaring as nullable.
    ...
    public void SetupDevelopAleksandrov(bool isShowSql)
    {
        JsonSettings.SetupTestsDevelopAleksandrov(Directory.GetCurrentDirectory(),
            MdNetUtils.GetLocalDeviceName(true), nameof(WsWeightTests), isShowSql);
    ...
    public void AssertSqlDbContentValidate<T>(bool isShowMarked = false) where T : WsSqlTableBase, new()
    {
        AssertAction(() =>
        {
            ...
            //DataCoreTestsUtils.DataCore.PrintTopRecords(items, 10, true);
            if (!items.Any())
    ...
    public void AssertSqlDbContentSerialize<T>() where T : WsSqlTableBase, new()
    {
        AssertAction(() =>
        {
            ...
            List<T> items = DataContext.GetListNotNullable<T>(sqlCrudConfig);
            Assert.IsTrue(items.Any());
            //DataCoreTestsUtils.DataCore.PrintTopRecords(items, 10, true, true);
            if (!items.Any())
                TestContext.WriteLine($"{nameof(items)} is null or empty!");
            else
            {
