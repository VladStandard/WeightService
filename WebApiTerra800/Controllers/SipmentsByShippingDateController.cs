...
{
    public class SipmentsByShippingDateController : ApiController
    {
        ...
        // GET: api/SipmentsByShippingDate/?StartDate=2020-04-20T00:00:00&EndDate=2020-04-21T00:00:00
        public HttpResponseMessage Get(DateTime StartDate, DateTime EndDate)
        {
            ...
            using SqlCommand cmd = SqlHelper.GetCommand("SELECT [IIS].[fnGetSipmentListByShippingDate] (@StartDate, @EndDate)", conn, sqlParameters);
            try
            {
