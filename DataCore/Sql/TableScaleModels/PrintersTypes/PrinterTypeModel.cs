...
/// </summary>
[Serializable]
[DebuggerDisplay("{nameof(PrinterTypeModel)}")]
public class PrinterTypeModel : WsSqlTableBase
{
    ...
    protected PrinterTypeModel(SerializationInfo info, StreamingContext context) : base(info, context)
    {
        //
    }
