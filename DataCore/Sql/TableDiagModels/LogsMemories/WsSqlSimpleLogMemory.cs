...
[DebuggerDisplay("Type = {nameof(WsSqlSimpleLogMemory)} | {CreateDt:yyyy-MM-dd} | {AppName} | {DeviceName} | {ScaleName} | {SizeAppMb} | {SizeFreeMb}")]
public sealed record WsSqlSimpleLogMemory
{
    ...
    /// Empty constructor.
    /// </summary>
    public WsSqlSimpleLogMemory() : this(DateTime.MinValue)
    {
        //
    }
    ...
    public WsSqlSimpleLogMemory(DateTime createDt, string appName = "", string deviceName = "", string scaleName = "",
