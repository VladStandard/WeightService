...
#pragma warning restore CS8618 // Non-nullable field must contain a non-null value when exiting constructor. Consider declaring as nullable.
    ...
    public string GetGtinWithCheckDigit(string code, GtinVariant gtinVariant = GtinVariant.Var3)
    {
        ...
        {
            GtinVariant.Var1 => $"{code}{GetGtinCheckDigitV3(code)}",
            GtinVariant.Var2 => $"{code}{GetGtinCheckDigitV2(code)}",
    ...
    public void SetBarCodeTop(BarCodeModel barCode, PluLabelContextModel pluLabelContext)
    {
    ...
    /// <param name="barCode"></param>
    /// <param name="pluLabelContext"></param>
    public void SetBarCodeRight(BarCodeModel barCode, PluLabelContextModel pluLabelContext)
    {
    ...
    ///  <param name="barCode"></param>
    ///  <param name="pluLabelContext"></param>
    public void SetBarCodeBottom(BarCodeModel barCode, PluLabelContextModel pluLabelContext)
    {
