...
public static class DataAccessHelperCrud
{
	...
	public static ICriteria GetCriteria<T>(this DataAccessHelper dataAccess, ISession session, SqlCrudConfigModel sqlCrudConfig) where T : TableBase, new()
	{
	...
	public static void Save<T>(this DataAccessHelper dataAccess, T? item) where T : TableBase, new()
	{
		if (item is null)
			return;
	...
	public static void Update<T>(this DataAccessHelper dataAccess, T? item) where T : TableBase, new()
	{
		if (item is null)
			return;
	...
	public static void Delete<T>(this DataAccessHelper dataAccess, T? item) where T : TableBase, new()
	{
		if (item is null)
			return;
	...
	public static void Mark<T>(this DataAccessHelper dataAccess, T? item) where T : TableBase, new()
	{
		if (item is null)
			return;
	...
	public static bool IsExistsItem<T>(this DataAccessHelper dataAccess, T? item) where T : TableBase, new()
	{
		if (item is null)
			return false;
	...
	public static bool IsExistsItem<T>(this DataAccessHelper dataAccess, SqlCrudConfigModel sqlCrudConfig) where T : TableBase, new()
	{
		bool result = false;
