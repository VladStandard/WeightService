...
#pragma warning restore CS8618 // Non-nullable field must contain a non-null value when exiting constructor. Consider declaring as nullable.
    ...
    public string PluGtinNotSet => Lang == Lang.English ? "GTIN is not set" : "ГТИН не задан";
    ...
    public string StateNotResponsed => Lang == Lang.English ? "not responsed" : "не отвечает";
    public string StateResponsed => Lang == Lang.English ? "responsed" : "отвечает";
