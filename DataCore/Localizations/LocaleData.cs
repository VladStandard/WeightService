    ...
    public static class LocaleData
    {
        ...
        public static class DeviceControl
        {
            ...
            public static class UriRouteItem
            {
                ...
                public const string PluLabel = "/item/plu_label";
                public const string PluObsolete = "/item/plu_obsolete";
                public const string PluScale = "/item/plu_scale";
                public const string PluWeighing = "/item/plu_weighing";
            ...
            public static class UriRouteSection
            {
                ...
                public const string PluLabels = "/section/plu_labels";
                public const string PlusObsolete = "/section/plus_obsolete";
                public const string PlusScales = "/section/plus_scales";
                public const string PlusWeighings = "/section/plu_weighings";
                public const string PlusWeighingsAggregation = "/section/plu_weighings_aggr";
