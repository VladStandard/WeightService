...
#pragma warning disable CS8618 // Non-nullable field must contain a non-null value when exiting constructor. Consider declaring as nullable.
        private static ScalesHelper _instance;
#pragma warning restore CS8618 // Non-nullable field must contain a non-null value when exiting constructor. Consider declaring as nullable.
        public static ScalesHelper Instance => LazyInitializer.EnsureInitialized(ref _instance);
        ...
        public string ButtonSelectPluWeight => Lang == ShareEnums.Lang.English ? $"Must select weight PLU!{Environment.NewLine}Or Massa-K scales are not respond!" : $"Необходимо выбрать весовую ПЛУ!{Environment.NewLine}Либо весы Масса-К не отвечают!";
        ...
        public string PluIsEmpty => Lang == ShareEnums.Lang.English ? "PLU not selected!" : "Не выбрана PLU!";
